...
@Config
@TeleOp(group = "dev")
public class NewBezierTest extends LinearOpMode {
...
//        telemetry.addData("In if condition", 0);
        ...
        BezierTraj bezier = new BezierTraj(drive.getPoseEstimate(), new Pose2d(p4X, p4Y, Math.toRadians(desired_heading)), new Vector2d(p2X, p2Y), new Vector2d(p3X, p3Y));
        drive.followTrajectory(bezier);
    }
